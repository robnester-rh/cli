...
func NewPolicyCache() *PolicyCache {
	log.Debugf("Creating new PolicyCache")
	return &PolicyCache{}
}
...
// CtxWithPolicyCache returns a new context with the provided PolicyCache added.
func CtxWithPolicyCache(ctx context.Context, cache *PolicyCache) context.Context {
